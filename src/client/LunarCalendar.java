...
public class LunarCalendar {
    ...
    // 农历部分假日
    final static String[] lunarHoliday = new String[] {"0100 除夕","0101 春节", "0115 元宵", "0505 端午", "0715 中元", "0815 中秋", "0909 重阳", "1208 腊八", "1224 小年" };
 
    // 公历部分节假日
    final static String[] solarHoliday = new String[] { //
            "0101 元旦", "0214 情人", "0308 妇女", "0312 植树", "0401 愚人", "0501 劳动", "0504 青年", //
            "0512 护士", "0601 儿童", "0701 建党", "0801 建军", "0910 教师",//
            "1001 国庆", "1031 万圣", "1225 圣诞" };
